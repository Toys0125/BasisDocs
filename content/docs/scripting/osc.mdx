...
1. Add a `BasisOsc` component to the same GameObject as your script, or to a nearby object you can reference.
2. Place that object under a recognized Basis scope:
   - `BasisAvatar`
   - `BasisProp`
   - `BasisScene`
...
Set `ReceiveAll` when you want the component to observe every routed OSC message in its receiver scope.
