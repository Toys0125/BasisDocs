...
**You can not use the root's animator for the Rig Builder and will break animation and Basis armature loader.** None of your constraints will work either so just don't do it.
</Callout>
</Step>
<Step>
...
<Callout type="info">
This includes all source bones that are under the effect of the constraints. Fx: Wings that are affected by Jiggle Bones need `Rig Transform` components if you have a constraint reference them.
</Callout>
